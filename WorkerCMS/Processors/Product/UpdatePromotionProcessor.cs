...
namespace WorkerCMS.Processors.Product
{
    ...
    {
        public UpdatePromotionProcessor(ILogger<UpdatePromotionProcessor> logger, LogDbContext logDb)
            : base(logger, CrmJsonSerializerContext.Default.UpdatePromotionMessage, logDb)
        {
        }
    }
}
