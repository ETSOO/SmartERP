...
namespace WorkerCMS.Processors.Stock
{
    ...
    {
        public UpdateStockLineProcessor(ILogger<UpdateStockLineProcessor> logger, LogDbContext logDb)
            : base(logger, CrmJsonSerializerContext.Default.UpdateStockLineMessage, logDb)
        {
        }
    }
}
