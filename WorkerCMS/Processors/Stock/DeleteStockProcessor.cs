...
namespace WorkerCMS.Processors.Stock
{
    ...
    {
        public DeleteStockProcessor(ILogger<DeleteStockProcessor> logger, LogDbContext logDb)
            : base(logger, CrmJsonSerializerContext.Default.DeleteStockMessage, logDb)
        {
        }
    }
}
