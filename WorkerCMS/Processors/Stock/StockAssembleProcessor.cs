...
namespace WorkerCMS.Processors.Stock
{
    ...
    {
        public StockAssembleProcessor(ILogger<StockAssembleProcessor> logger, LogDbContext logDb)
            : base(logger, CrmJsonSerializerContext.Default.StockAssembleMessage, logDb)
        {
        }
    }
}
