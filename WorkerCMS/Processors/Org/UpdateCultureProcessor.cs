...
namespace WorkerCMS.Processors.Org
{
    ...
    {
        public UpdateCultureProcessor(ILogger<UpdateCultureProcessor> logger, LogDbContext logDb)
            : base(logger, CrmJsonSerializerContext.Default.UpdateCultureMessage, logDb)
        {
        }
    }
}
