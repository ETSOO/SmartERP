...
namespace WorkerCMS.Processors.Order
{
    ...
    {
        public UpdateOrderProcessor(ILogger<UpdateOrderProcessor> logger, LogDbContext logDb)
            : base(logger, CrmJsonSerializerContext.Default.UpdateOrderMessage, logDb)
        {
        }
    }
}
