...
namespace WorkerCMS.Processors.Order
{
    ...
    {
        public UpdateOrderLineProcessor(ILogger<UpdateOrderLineProcessor> logger, LogDbContext logDb)
            : base(logger, CrmJsonSerializerContext.Default.UpdateOrderLineMessage, logDb)
        {
        }
    }
}
