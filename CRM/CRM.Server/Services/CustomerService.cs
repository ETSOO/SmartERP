...
namespace CRM.Server.Services
{
    ...
    public class CustomerService : MyUserService, ICustomerService
    {
        ...
        public CustomerService(
            ...
            : base(app, config, userAccessor.UserSafe, "customer", logger)
        {
            _db = db;
        ...
        public async Task<IActionResult> CreateAsync(CustomerCreateRQ rq, CancellationToken cancellationToken = default)
        {
            ...
            {
                var tagIds = await _commonService.AddTagsAsync(FeatureTagKind.Customer, rq.Tags, cancellationToken);
        ...
        public async Task<IActionResult> UpdateAsync(CustomerUpdateRQ rq, CancellationToken cancellationToken = default)
        {
            ...
            if (rq.IsModified(nameof(rq.Categories)))
            {
                ...
                customer.CategoryIds = categoryIds?.ToList();
                customer.CategoryIdsAll = ids?.ToList();
            }
