...
namespace CRM.Server.Services
{
    public interface IPersonProfileService
    {
        ...
        Task<IActionResult> CreateLinkAsync(PersonProfileLinkCreateRQ rq, CancellationToken cancellationToken = default);
        Task<IActionResult> DeleteAttachmentAsync(long id, CancellationToken cancellationToken = default);
        Task<IActionResult> DeleteLinkAsync(long id, CancellationToken cancellationToken = default);
