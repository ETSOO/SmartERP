...
namespace CRM.Server.Endpoints
{
    ...
    public static class PersonProfile
    {
        public static RouteGroupBuilder MapPersonProfile(this RouteGroupBuilder builder)
        {
            ...
            g.MapPost("Update", (IPersonProfileService service, IHttpContextAccessor accessor, PersonProfileUpdateRQ rq, CancellationToken cancellationToken) => service.UpdateAsync(rq, cancellationToken))
