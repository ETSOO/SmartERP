...
namespace PlatformShared.Dto
{
    ...
    )
    {
        ...
        [
            ...
            new(AuthCodeAction.UserRegistrationEmailCode, 30, RandStringKind.Digit, 6, false, "Registration/EmailRegistration_{culture}"),
            new(AuthCodeAction.UserCallbackSMSCode, 10, RandStringKind.Digit, 6),
            new(AuthCodeAction.UserCallbackEmailCode, 30, RandStringKind.Digit, 6, false, "Callback/EmailCallback_{culture}"),
            new(AuthCodeAction.UserVerificationSMSCode, 10, RandStringKind.Digit, 6, true),
            new(AuthCodeAction.UserVerificationEmailCode, 30, RandStringKind.Digit, 6, true, "Verification/EmailVerification_{culture}"),

            // Member invitation, 3 days = 72 hours = 4320 minutes
            new(AuthCodeAction.MemberInvitationEmailCode, 4320, RandStringKind.DigitAndLetter, 16, true, "Invitation/EmailMemberInvitation_{culture}")
        ];
    }
}
