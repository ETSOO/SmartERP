...
namespace com.etsoo.Core.Database
{
    ...
    public interface ICommonDatabase
    {
        ...
        int Execute(string sql, bool? isStoredProcedure = false);
        ...
        /// <param name="isStoredProcedure">Is stored procedure</param>
        /// <returns>Rows affacted</returns>
        int Execute(string sql, IDictionary<string, dynamic> paras, bool? isStoredProcedure = false);
        ...
        object ExecuteScalar(string sql, bool? isStoredProcedure = false);
        ...
        /// <param name="isStoredProcedure">Is stored procedure</param>
        /// <returns>First row first column's value</returns>
        object ExecuteScalar(string sql, IDictionary<string, dynamic> paras, bool? isStoredProcedure = false);
