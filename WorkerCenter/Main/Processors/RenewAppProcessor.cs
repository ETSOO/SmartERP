...
namespace WorkerCenter.Main.Processors
{
    ...
    public class RenewAppProcessor : LogQueueProcessor<RenewAppMessage>
    {
        ...
        public RenewAppProcessor(ILogger<RenewAppProcessor> logger, IDbContextFactory<LogDbContext> logDbFactory,
            IDbContextFactory<MyDbContext> dbFactory, IMessageQueueProducer producer)
            : base(logger, PlatformSharedContext.Default.RenewAppMessage, logDbFactory)
        {
            _producer = producer;
