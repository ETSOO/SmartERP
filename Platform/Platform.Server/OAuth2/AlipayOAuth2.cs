    ...
    public static class AlipayOAuth2
    {
        public static RouteGroupBuilder MapAlipay(this RouteGroupBuilder builder)
        {
            ...
            g.MapGet("GetAuthUrl", (IWXClient client, HttpRequest request) =>
            {
                ...
                return $"https://openauth.alipay.com/oauth2/publicAppAuthorize.htm?app_id={"2021004153681483"}&redirect_uri={HttpUtility.UrlEncode("http://etsoo.v7.idcfengye.com/api/OAuth2/Alipay/")}&scope=auth_user&state={state}";
