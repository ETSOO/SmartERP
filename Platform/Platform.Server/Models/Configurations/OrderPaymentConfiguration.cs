...
{
    public partial class OrderPaymentConfiguration : IEntityTypeConfiguration<OrderPayment>
    {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<OrderPayment> entity);
    }
}
