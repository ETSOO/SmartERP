...
namespace Platform.Server.Endpoints.App
{
    ...
    public static class App
    {
        public static RouteGroupBuilder MapApp(this RouteGroupBuilder builder)
        {
            ...
            g.MapPut("CreateApiKey", async (IAppService service, IHttpContextAccessor accessor, AppCreateApiKeyRQ rq, CancellationToken cancellationToken) =>
            {
                // Check device
            ...
            g.MapGet("UpdateRead/{id:int}", (IAppService service, int id, IHttpContextAccessor accessor, CancellationToken cancellationToken) => service.UpdateReadAsync(id, accessor.GetJsonWriter(), cancellationToken))
